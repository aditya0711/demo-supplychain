...
function addSubProduct(adminName, parentId, childId, quantity){
    ...
    return function(scope){
        ...
        if (quantity   === undefined || quantity === 0) throw new Error('Product: INPUT quantity undefined');
            ...
            rest.verbose('addSubProduct', parentId, childId, quantity);

            const contractName = AI.subContractsNames.ProductManager;
            const E = getEnums().ErrorCodesEnum;

            return productMgrLib.addSubComponent(adminName, parentId, childId, quantity)(scope)
                .then(function (scope) {
                    ...
                    if (result == E.SUCCESS) {
                      return scope;
                        ...
                        throw new MethodError(contractName, 'addSubComponent', result);
                    }
                    return scope;
                });
        }
