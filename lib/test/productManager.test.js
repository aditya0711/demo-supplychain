    ...
    it('should create the product manager and add products', function(done){
        ...
        rest.setScope(scope)
            ...
            .then(function(scope){
                ...
                console.log("Result: " + result + " ENUM: " + E[E.SUCCESS]) ;
             ...
             .then(function(scope){
                            //returns ErrorCodesEnum
                            const result2 = scope.contracts[contractName].calls[method];
                            console.log("Result: " + result2 + " ENUM: " + E[E.SUCCESS]) ;
                            assert.equal(result2, E.PRODUCT_EXISTS, 'addProduct should return' + E[E.PRODUCT_EXISTS]);
                            return scope;
                        })
            .then(function(scope){
                done();
            ...
            //.then(rest.callMethod(adminName, contractName, method, ms.createProductArgs(product[0])))
