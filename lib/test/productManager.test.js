   ...
   it('should add a component to an existing product', function(done){
        ...
        rest.setScope(scope)
            ...
            .then(function(scope){
                ...
                //components[0].product_contract_address = products[1];
            ...
            // Throw error if product doesn't exist. It should not add component if product doesn't exist.
            .then(rest.callMethod(adminName, contractName, methodName, ms.createComponentArgs(components[1])))
            .then(function(scope){
                 const result = scope.contracts[contractName].calls[methodName]
                 assert.equal(result, E.PRODUCT_NOT_EXISTS, 'addComponent should return ' + E[E.PRODUCT_NOT_EXISTS]);
                 return scope;
            })
...
//             .then(function(scope){
//                 _.each(components, function(component, index, components) {
//                     rest.callMethod(adminName, contractName, methodName, ms.createComponentArgs(component))
//                     assert.equal(result, E.SUCCESS, 'Multiple addComponent should return' + E[E.SUCCESS])
//                     return scope;
//                 })
//             })
            .then(function(scope){
