...
const ErrorCodesEnum = rest.getEnums(`./lib/common/ErrorCodesEnum.sol`).ErrorCodesEnum;
const GovernUserRole = rest.getEnums(`./lib/user/contracts/GovernUserRoleEnum.sol`).GovernUserRole;
const GovernUserState = rest.getEnums(`./lib/user/contracts/GovernUserStateEnum.sol`).GovernUserState;
